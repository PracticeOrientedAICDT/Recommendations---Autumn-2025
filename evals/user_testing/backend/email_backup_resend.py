"""
BULLETPROOF Email backup using Resend API (HTTPS - never blocked).
Works everywhere including Render. Simple and reliable.
"""
...
def send_experiment_email_resend(participant_id, data_dict):
    """
    Send experiment data via Resend API with CSV and JSON attachments.
    ...
    """
    # Get Resend API key and email config
        ...
        params = {
            ...
            "attachments": [
                ...
                },
                {
                    ...
                    "content": list(json_content.encode('utf-8'))
                }
            ]
        }
